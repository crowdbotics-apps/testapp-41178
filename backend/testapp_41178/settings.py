"""
Django settings for testapp_41178 project.
...
ROOT_URLCONF = 'testapp_41178.urls'
...
WSGI_APPLICATION = 'testapp_41178.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp_41178 API",
    "DESCRIPTION": "API documentation for testapp_41178 App",
    "VERSION": "v1",
}
